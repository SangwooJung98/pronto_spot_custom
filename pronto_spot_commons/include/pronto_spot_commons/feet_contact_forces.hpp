...
#include <spot_robcogen/inverse_dynamics.h>
#include <spot_robcogen/jsim.h>
...
private:
    pronto::spot::dyn::InertiaProperties inertia_prop_;
    pronto::spot::MotionTransforms motion_transf_;
    pronto::spot::ForceTransforms force_transf_;
    pronto::spot::dyn::InverseDynamics inverse_dynamics_;
    pronto::spot::dyn::JSIM jsim_;
